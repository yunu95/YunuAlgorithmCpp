...
"));
        ...
        priority_queue<Node*,vector<Node*>,less<Node*>> openSet;
        vector<Node*> openSet2;
        openSet2.push_back(&nodeMap[0][0]);
        openSet2.push_back(&nodeMap[1][0]);
        openSet2.push_back(&nodeMap[2][0]);
        openSet2.push_back(&nodeMap[3][0]);
        openSet2.push_back(&nodeMap[0][1]);
        openSet2.push_back(&nodeMap[0][2]);
        sort(openSet2.begin(), openSet2.end());
